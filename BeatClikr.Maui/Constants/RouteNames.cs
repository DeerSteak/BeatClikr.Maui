using BeatClikr.Maui.Views;

namespace BeatClikr.Maui.Constants;

public static class RouteNames
{
    public readonly static string AboutRoute = nameof(AboutPage);
    public readonly static string AppShellRoute = nameof(AppShell);
    ...
    public readonly static string GetStartedRoute = nameof(GetStartedPage);
}
